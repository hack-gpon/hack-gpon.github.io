...
<ImageFigure file="avm/avm_serial.jpg" alt="Serial number form" caption="Serial number form" />
...
<ImageFigure file="avm/avm_ploam.png" alt="PLOAM Password form" caption="PLOAM Password form" />
