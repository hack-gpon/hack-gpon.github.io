...
<Alert content="" alert="Note" icon="svg-info" color="blue" />
...
<Alert content="The PLOAM password can be saved in either ASCII or HEX format, without any 0x or separators" alert="Note" icon="svg-info" color="blue" />
...
<Alert content="The PLOAM password is stored in HEX format, without any 0x or separators" alert="Note" icon="svg-info" color="blue" />
